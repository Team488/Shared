...
public class StateRepresentation<S, T> {
    ...
    private final List<Action> heartbeatActions = new ArrayList<>();
    ...
    public void addHeartbeatAction(final Action heartbeatAction)
    {
    	heartbeatActions.add(heartbeatAction);
    }
    
    void executeHeartbeatActions() {        
        for (Action action : heartbeatActions) {
            action.doIt();
        }
    }
