...
public class StateConfiguration<S, T> {
    ...
    /**
     * Specify an action that will execute on heartbeat
     * 
     * @param heartbeatAction Action to execute
     * @return The receiver
     */
    public StateConfiguration<S, T> onHeartbeat(final Action heartbeatAction)
    {
    	assert heartbeatAction != null : "heartbeatAction is null";
    	
    	representation.addHeartbeatAction(heartbeatAction);
