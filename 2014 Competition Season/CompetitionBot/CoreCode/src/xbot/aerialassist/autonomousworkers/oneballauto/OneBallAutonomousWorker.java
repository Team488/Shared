...
public class OneBallAutonomousWorker extends AerialStateMachineWorker {
    ...
    {        
        ...
        int stopDriveHot = this.stateMachine.addWorker(new DriveForTimeWorker(0, 0, 50));
        int stopDriveNotHot = this.stateMachine.addWorker(new DriveForTimeWorker(0, 0, 50));
