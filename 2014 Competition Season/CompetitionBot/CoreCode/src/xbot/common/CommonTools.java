...
public class CommonTools {
     ...
     */
    public ITrigUtil trigUtil;
    
    private CommonTools(Time time, LogWriter logWriter, LogWriter telemetryWriter,
            PermanentStorageProxy permStore, ITableProxy randomStore, ITrigUtil trigUtil) {
     ...
     * @param trigUtil  The math utility to use
     */
    public static void CreateCommonTools(Time time, LogWriter logWriter, 
            ...
            ITableProxy randomStore, ITrigUtil trigUtil)
    {
