 ...
 */
public class XBotGyro extends SensorBase implements ISensor, LiveWindowSendable {
    ...
    private void initGyro() {
        ...
        m_voltsPerDegreePerSecond = m_voltsPerDegreePerSecond;
     ...
     */
    public XBotGyro(int slot, int channel, double volts) {
     ...
     */
    public XBotGyro(AnalogChannel channel, double volts) {
        m_voltsPerDegreePerSecond = volts;
        m_analog = channel;
        if (m_analog == null) {
