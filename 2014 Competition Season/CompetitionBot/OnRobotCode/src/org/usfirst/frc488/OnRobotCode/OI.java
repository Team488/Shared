...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        rightButton5.whenPressed(new CommandProxy(new SetDesiredHeadingWorker(180)));
        
        DoubleProperty driveForwardTimeout = 
                new DoubleProperty("DriveForwardTimeOutMS", 2500);
        Command driveForwardCommand = 
                new CommandProxy(
                    new DriveForTimeWorker(0, 1.0, driveForwardTimeout), 
                    Robot.drive);
        ...
        operatorButton12.whenPressed(fireCatapultUnderDuressCommand);
        ...
        operatorButton6.whileHeld(new CommandProxy(new AskingForBallWorker()));
    ...
    private void InitializeAllJoystickButtons()
    {
        ...
        leftButton8 = new JoystickButton(leftJoystick, 8); // Subject to change
        leftButton9 = new JoystickButton(leftJoystick, 9); // STC
        leftButton10 = new JoystickButton(leftJoystick, 10); // STC
        leftButton11 = new JoystickButton(leftJoystick, 11); // STC
        ...
        rightButton11 = new JoystickButton(rightJoystick, 11);
