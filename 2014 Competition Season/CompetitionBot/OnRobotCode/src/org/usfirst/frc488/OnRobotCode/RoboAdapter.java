...
public class RoboAdapter extends Loggable {
    ...
    public void UpdateNormal()
    {
        ...
        frontCollector.getSensors().SetBallSensorVoltage(RobotMap.sensorsFrontCollectorBallDetector.getVoltage());
...
//        {
        ...
        backCollector.getSensors().SetBallSensorVoltage(RobotMap.sensorsBackCollectorBallDetector.getVoltage());
        ...
        if (RobotMap.sensorsIMU != null)
        {
            sensors.DepositLocationInformationFromRobot(
                    RobotMap.sensorsIMU.getYaw(),
                    RobotMap.sensorsLeftFollowWheel.get(),
                    -RobotMap.sensorsRightFollowWheel.get(),
                    RobotMap.sensorsMiddleFollowWheel.get());
        }
        else
        {
            sensors.DepositLocationInformationFromRobot(
